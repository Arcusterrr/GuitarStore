...
{
    [Route("admin/api/v1/users"), AuthorizeByRoles(UserRole.Admin, UserRole.Moderator)]
    public class UserAdminController : QueryController<UserViewModel, User, UserViewModel>
    {
